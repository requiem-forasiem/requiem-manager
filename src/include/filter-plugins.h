...
requiem_bool_t filter_plugins_available(manager_filter_category_t type);
...
int filter_plugins_run_by_plugin(idmef_message_t *message, requiem_plugin_instance_t *plugin);
