...
int xmlmod_LTX_requiem_plugin_version(void);
int xmlmod_LTX_manager_plugin_init(requiem_plugin_entry_t *pe, void *data);
...
REQUIEM_PLUGIN_OPTION_DECLARE_STRING_CB(xmlmod, xmlmod_plugin_t, logfile)
...
static int file_write(void *context, const char *buf, int len)
{
        ...
        if ( ret != (size_t ) len && ferror((FILE *) context) ) {
                requiem_log(REQUIEM_LOG_ERR, "could not write IDMEF-XML data: '%s'.\n", strerror(errno));
                return -1;
        }
...
static void idmef_content_string(xmlNodePtr node, const char *tag, requiem_string_t *string)
{
        const char *content;
        ...
        content = requiem_string_get_string(string);
...
static void idmef_attr_string(xmlNodePtr node, const char *attr, requiem_string_t *string)
{
        const char *content;
...
static void process_time(xmlNodePtr parent, const char *type, idmef_time_t *time, requiem_bool_t enable_ntpstamp)
{
        int ret;
        xmlNodePtr new;
        ...
        new = xmlNewTextChild(parent, NULL, (const xmlChar *) type, (const xmlChar *) requiem_string_get_string(out));
        if ( ! new ) {
                requiem_string_destroy(out);
                return;
        }
        ...
        if ( enable_ntpstamp ) {
                ...
                xmlSetProp(new, (const xmlChar *) "ntpstamp", (const xmlChar *) requiem_string_get_string(out));
        }
...
static void process_user_id(xmlNodePtr parent, idmef_user_id_t *user_id)
{
        ...
        idmef_content_generic_optional(new, "number", "%" REQUIEM_PRIu32, idmef_user_id_get_number(user_id));
}
...
static void process_process(xmlNodePtr parent, idmef_process_t *process)
{
        ...
        idmef_content_generic_optional(new, "pid", "%" REQUIEM_PRIu32, idmef_process_get_pid(process));
        idmef_content_string(new, "path", idmef_process_get_path(process));

        string = NULL;
        while ( (string = idmef_process_get_next_arg(process, string)) )
                xmlNewTextChild(new, NULL, (const xmlChar *) "arg", (const xmlChar *) requiem_string_get_string(string));

        string = NULL;
        while ( (string = idmef_process_get_next_env(process, string)) )
                xmlNewTextChild(new, NULL, (const xmlChar *) "env", (const xmlChar *) requiem_string_get_string(string));
}
...
static void process_snmp_service(xmlNodePtr parent, idmef_snmp_service_t *snmp)
{
        ...
        idmef_content_generic_optional(new, "messageProcessingModel", "%" REQUIEM_PRIu32, idmef_snmp_service_get_message_processing_model(snmp));
        idmef_content_generic_optional(new, "securityModel", "%" REQUIEM_PRIu32, idmef_snmp_service_get_security_model(snmp));
        idmef_content_string(new, "securityName", idmef_snmp_service_get_security_name(snmp));
        idmef_content_generic_optional(new, "securityLevel", "%" REQUIEM_PRIu32, idmef_snmp_service_get_security_level(snmp));
...
static void process_web_service(xmlNodePtr parent, idmef_web_service_t *web)
{
        ...
        while ( (arg = idmef_web_service_get_next_arg(web, arg)) )
                xmlNewTextChild(new, NULL, (const xmlChar *) "arg", (const xmlChar *) requiem_string_get_string(arg));
}
...
static void process_service(xmlNodePtr parent, idmef_service_t *service)
{
        ...
        idmef_attr_generic_optional(new, "ip_version", "%" REQUIEM_PRIu8, idmef_service_get_ip_version(service));
        idmef_content_string(new, "name", idmef_service_get_name(service));
        idmef_content_generic_optional(new, "port", "%" REQUIEM_PRIu16, idmef_service_get_port(service));
        idmef_attr_generic_optional(new, "iana_protocol_number", "%" REQUIEM_PRIu8, idmef_service_get_iana_protocol_number(service));
...
static void process_file_access(xmlNodePtr parent, idmef_file_access_t *file_access)
{
        ...
        while ( (permission = idmef_file_access_get_next_permission(file_access, permission)) )
                xmlNewTextChild(new, NULL, (const xmlChar *) "Permission", (const xmlChar *) requiem_string_get_string(permission));
}
...
static void process_inode(xmlNodePtr parent, idmef_inode_t *inode)
{
        ...
        idmef_content_generic_optional(new, "number", "%" REQUIEM_PRIu32, idmef_inode_get_number(inode));
        idmef_content_generic_optional(new, "major-device", "%" REQUIEM_PRIu32,  idmef_inode_get_major_device(inode));
        idmef_content_generic_optional(new, "minor-device", "%" REQUIEM_PRIu32, idmef_inode_get_minor_device(inode));
        idmef_content_generic_optional(new, "c-major-device", "%" REQUIEM_PRIu32, idmef_inode_get_c_major_device(inode));
        idmef_content_generic_optional(new, "c-minor-devide", "%" REQUIEM_PRIu32, idmef_inode_get_c_minor_device(inode));
}
...
static void process_file(xmlNodePtr parent, idmef_file_t *file)
{
        ...
        idmef_content_generic_optional(new, "data-size", "%" REQUIEM_PRIu64, idmef_file_get_data_size(file));
        idmef_content_generic_optional(new, "disk-size", "%" REQUIEM_PRIu64, idmef_file_get_disk_size(file));
...
static void process_additional_data(xmlNodePtr parent, idmef_additional_data_t *ad)
{
        ...
        xmlNewTextChild(new, NULL, (const xmlChar *) idmef_additional_data_type_to_string(
                        ...
                        (const xmlChar *) requiem_string_get_string(out));
...
static void process_correlation_alert(xmlNodePtr parent, idmef_correlation_alert_t *ca)
{
        ...
        xmlNewTextChild(new, NULL, (const xmlChar *) "name", (const xmlChar *) requiem_string_get_string(idmef_correlation_alert_get_name(ca)));
        ...
        while ( (alertident = idmef_correlation_alert_get_next_alertident(ca, alertident)) ) {
                anew = xmlNewTextChild(new, NULL, (const xmlChar *) "alertident",
                                       (const xmlChar *) requiem_string_get_string(idmef_alertident_get_alertident(alertident)));
                if ( ! anew )
                        break;
...
static int xmlmod_run(requiem_plugin_instance_t *pi, idmef_message_t *message)
{
        xmlNodePtr root;
        xmlDoc *document;
        xmlmod_plugin_t *plugin = requiem_plugin_instance_get_plugin_data(pi);

        document = xmlNewDoc((const xmlChar *) "1.0");
        if ( ! document ) {
                requiem_log(REQUIEM_LOG_ERR, "error creating XML document.\n");
                return -1;
        }
        ...
        default:
                requiem_log(REQUIEM_LOG_ERR, "unknow message type: %d.\n", idmef_message_get_type(message));
                xmlFreeDoc(document);
                return -1;
        }
...
static int xmlmod_init(requiem_plugin_instance_t *pi, requiem_string_t *out)
{
        FILE *fd;
        xmlmod_plugin_t *plugin = requiem_plugin_instance_get_plugin_data(pi);
        ...
        if ( ! plugin->logfile ) {
                ...
                requiem_string_sprintf(out, "error opening %s for writing", plugin->logfile);
                return -1;
        }
...
static void xmlmod_destroy(requiem_plugin_instance_t *pi, requiem_string_t *out)
{
        xmlmod_plugin_t *plugin = requiem_plugin_instance_get_plugin_data(pi);
...
static int xmlmod_activate(requiem_option_t *opt, const char *arg, requiem_string_t *err, void *context)
{
        xmlmod_plugin_t *new;
        ...
        if ( ! new->fd ) {
                requiem_string_sprintf(err, "error creating an XML output buffer");
                free(new);
                return -1;
        }
...
static int set_dtd_check(requiem_option_t *option, const char *arg, requiem_string_t *err, void *context)
{
        xmlmod_plugin_t *plugin = requiem_plugin_instance_get_plugin_data(context);
        ...
        if ( ! plugin->idmef_dtd ) {
                requiem_string_sprintf(err, "error loading IDMEF DTD '%s'", IDMEF_DTD);
                return -1;
        }
...
static int enable_formatting(requiem_option_t *option, const char *arg, requiem_string_t *err, void *context)
{
        xmlmod_plugin_t *plugin = requiem_plugin_instance_get_plugin_data(context);
...
static int get_formatting(requiem_option_t *opt, requiem_string_t *out, void *context)
{
        xmlmod_plugin_t *plugin = requiem_plugin_instance_get_plugin_data(context);

        requiem_string_sprintf(out, "%s", plugin->format ? "true" : "false");
...
static int disable_buffering(requiem_option_t *option, const char *arg, requiem_string_t *err, void *context)
{
        xmlmod_plugin_t *plugin = requiem_plugin_instance_get_plugin_data(context);
...
int xmlmod_LTX_manager_plugin_init(requiem_plugin_entry_t *pe, void *rootopt)
{
        int ret;
        requiem_option_t *opt, *cur;
        ...
        ret = requiem_option_add(rootopt, &opt, hook, 0, "xmlmod", "Option for the xmlmod plugin",
                                 REQUIEM_OPTION_ARGUMENT_OPTIONAL, xmlmod_activate, NULL);
        if ( ret < 0 )
                return ret;

        requiem_plugin_set_activation_option(pe, opt, xmlmod_init);

        ret = requiem_option_add(opt, NULL, hook, 'l', "logfile", "Specify output file to use",
                                 REQUIEM_OPTION_ARGUMENT_REQUIRED, xmlmod_set_logfile, xmlmod_get_logfile);
        if ( ret < 0 )
                return ret;

        ret = requiem_option_add(opt, &cur, hook, 'v', "validate", "Validate IDMEF XML output against DTD",
                                 REQUIEM_OPTION_ARGUMENT_OPTIONAL, set_dtd_check, NULL);
        if ( ret < 0 )
                return ret;
        requiem_option_set_input_type(cur, REQUIEM_OPTION_INPUT_TYPE_BOOLEAN);

        ret = requiem_option_add(opt, &cur, hook, 'f', "format", "Format XML output so that it is readable",
                                 REQUIEM_OPTION_ARGUMENT_OPTIONAL, enable_formatting, get_formatting);
        if ( ret < 0 )
                return ret;
        requiem_option_set_input_type(cur, REQUIEM_OPTION_INPUT_TYPE_BOOLEAN);

        ret = requiem_option_add(opt, NULL, hook, 'd', "disable-buffering",
                                 "Disable output file buffering to prevent truncated tags",
                                 REQUIEM_OPTION_ARGUMENT_OPTIONAL, disable_buffering, NULL);
        if ( ret < 0 )
                return ret;

        requiem_plugin_set_name(&xmlmod_plugin, "XmlMod");
        requiem_plugin_set_destroy_func(&xmlmod_plugin, xmlmod_destroy);
        manager_report_plugin_set_running_func(&xmlmod_plugin, xmlmod_run);

        requiem_plugin_entry_set_plugin(pe, (void *) &xmlmod_plugin);
